...
Visualization of results generated by the enrichment module. 1) Results: Number of circular RNAs per repeat category (p<0.05) 2) Top 3 repeat categories with enrichment within the flanking introns (max. +/- 2kb) of the significantly enriched circRNA candidates c) Detailed view of the repeat "peaks" enriched in the flanking introns of isoform 1 of circRyr2.