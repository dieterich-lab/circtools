...
```{r eval=FALSE}
circs <- circsData(db, sjList)
plotCircsFor(circsData = circs,
             gene = "ENSG00000113916",
             keytype = "GENEID", #default
             primers = primers, # IRanges
             counts = counts, # data.frame with two columns id:count
             opts = list(biotype='all'))
